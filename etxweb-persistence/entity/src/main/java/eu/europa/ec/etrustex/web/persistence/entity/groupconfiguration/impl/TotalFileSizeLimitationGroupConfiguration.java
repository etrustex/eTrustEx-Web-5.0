...
@NoArgsConstructor
@SuperBuilder
public class TotalFileSizeLimitationGroupConfiguration extends IntegerGroupConfiguration {
    public static final String URL = GroupConfiguration.URL_TEMPLATE + "TotalFileSizeLimitationGroupConfiguration/";
}
