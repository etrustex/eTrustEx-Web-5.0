...
@NoArgsConstructor
@SuperBuilder
public class FileSizeLimitationGroupConfiguration extends IntegerGroupConfiguration {
    public static final String URL = GroupConfiguration.URL_TEMPLATE + "FileSizeLimitationGroupConfiguration/";
