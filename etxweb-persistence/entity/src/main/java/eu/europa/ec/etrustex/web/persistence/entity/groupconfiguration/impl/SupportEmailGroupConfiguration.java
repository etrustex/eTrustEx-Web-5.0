...
@NoArgsConstructor
@SuperBuilder
public class SupportEmailGroupConfiguration extends StringGroupConfiguration {
    public static final String URL = GroupConfiguration.URL_TEMPLATE + "SupportEmailGroupConfiguration/";
