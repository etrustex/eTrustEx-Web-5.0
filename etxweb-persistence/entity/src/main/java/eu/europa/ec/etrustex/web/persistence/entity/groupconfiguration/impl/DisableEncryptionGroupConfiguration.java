...
@SuperBuilder
public class DisableEncryptionGroupConfiguration extends BooleanGroupConfiguration {
    public static final String URL = GroupConfiguration.URL_TEMPLATE + "DisableEncryptionGroupConfiguration/";
