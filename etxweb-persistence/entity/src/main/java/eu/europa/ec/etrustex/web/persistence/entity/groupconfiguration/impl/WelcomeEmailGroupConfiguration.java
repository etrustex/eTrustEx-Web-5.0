...
@SuperBuilder
public class WelcomeEmailGroupConfiguration extends BooleanGroupConfiguration {
    public static final String URL = GroupConfiguration.URL_TEMPLATE + "WelcomeEmailGroupConfiguration/";
