...
@SuperBuilder
public class EnforceEncryptionGroupConfiguration extends BooleanGroupConfiguration {
    public static final String URL = GroupConfiguration.URL_TEMPLATE + "EnforceEncryptionGroupConfiguration/";
