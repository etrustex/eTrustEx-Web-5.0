...
@NoArgsConstructor
@SuperBuilder
public class RetentionPolicyEntityConfiguration extends IntegerGroupConfiguration {
    public static final String URL = GroupConfiguration.URL_TEMPLATE + "RetentionPolicyEntityConfiguration/";
