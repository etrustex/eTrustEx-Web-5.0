...
import ButtonVariant from '@/shared/views/bootstrap_vue/types/ButtonVariant'
import InputType from '@/shared/views/bootstrap_vue/types/InputType'
import ColorVariant from '@/shared/views/bootstrap_vue/types/ColorVariant'
import InputSize from '@/shared/views/bootstrap_vue/types/InputSize'
import useBooleanish from '@/shared/views/bootstrap_vue/composables/useBooleanish'
import useId from '@/shared/views/bootstrap_vue/composables/useId'
...
const addTag = (tag?: string): void => {
  ...
  const tempValue = tag.split(';').map(e => e.split(',')).reduce((acc, cur) => cur.concat(acc), []).filter(e => !!e)
  const newValue = [...props.modelValue, ...tempValue]
  inputValue.value = ''
  shouldRemoveOnDelete.value = true
