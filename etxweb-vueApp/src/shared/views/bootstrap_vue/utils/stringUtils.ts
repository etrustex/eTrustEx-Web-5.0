import { isPlainObject } from '@/shared/views/bootstrap_vue/utils/inspect'
import { RX_FIRST_START_SPACE_WORD, RX_LOWER_UPPER, RX_START_SPACE_WORD, RX_UNDERSCORE } from '@/shared/views/bootstrap_vue/utils/regex'
