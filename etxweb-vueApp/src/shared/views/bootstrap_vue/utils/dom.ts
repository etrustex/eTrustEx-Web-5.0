...
import type { AnimationFrame } from '@/shared/views/bootstrap_vue/types/safeTypes'
import { toString } from './stringUtils'

const HAS_DOCUMENT_SUPPORT = typeof document !== 'undefined'
const DOCUMENT = HAS_DOCUMENT_SUPPORT ? document : ({} as Record<string, any>)
const HAS_WINDOW_SUPPORT = typeof window !== 'undefined'
const HAS_ELEMENT_SUPPORT = typeof Element !== 'undefined'
