<template>
  <div class="container my-5">
    <div class="d-flex justify-content-between mt-3">
      <h2 class="h3 variant">{{ title }}</h2>
      <div class="d-flex align-items-md-end">
        <more-information v-if="showInfoButton && infoContent" :content="infoContent" class="my-auto" placement="right"/>
        ...
        <div class="col text-end btns">
          ...
          <button type="button" class="btn btn-primary btn-ico" :disabled="disableConfirm"
            ...
            <span class="ico-conjunction">
              <i aria-hidden="true" :class="confirmClass"></i>
            </span>
...
const props = defineProps({
  ...
  confirmClass: { type: String, required: false, default: 'ico-save-white' },
