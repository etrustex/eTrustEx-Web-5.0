...
import eu.europa.ec.etrustex.web.service.validation.validator.UserExistsForGroupValidator;
...
@Constraint(validatedBy = { UserExistsForGroupValidator.class })
@Target({ TYPE })
@Retention(RUNTIME)
@Documented
public @interface CheckUserExistsForGroup {
